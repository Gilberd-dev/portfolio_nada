            ...
            <div class="col-lg-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/updatedoing/{{ $edit -> id }}" enctype="multipart/form-data" method="post">
                            @csrf
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" style="height: 100px" name="description">{{ $edit -> description }}</textarea>
                                </div>
                            </div>
